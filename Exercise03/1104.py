...
class hyperion:
    def __init__(self,GM=4*math.pi**2,dt=0.0001,time=10):
        ...
        self.t=[[0],[0],[0],[0]]
        self.w=[[0],[0],[0],[0]]
        self.theta=[[0.01],[0.01],[0.01],[0.01]]
    ...
    def show_results(self,color):
        ...
        ax4=plt.subplot(224)
        plt.sca(ax1)
        plt.plot(self.t[0],self.dw[0],'r',label=r'd$\Theta$=0.01,v=6 Elliptical orbit')
        ...
        plt.sca(ax2)
        plt.plot(self.t[1],self.dw[1],'r',label=r'd$\Theta$=0.01,v=5 Elliptical orbit')
        plt.title(r'Hyperion  $\Delta{\omega}$ versus time',fontsize=12)
        plt.xlabel(u'time(yr)',fontsize=12)
        plt.ylabel(u'$\Delta{\omega}$(radians/yr)',fontsize=12)
        plt.legend(fontsize=10,loc='best')
        plt.sca(ax3)
        plt.plot(self.t[2],self.dw[2],'r',label=r'd$\Theta$=0.01,v=4 Elliptical orbit')
        plt.title(r'Hyperion  $\Delta{\omega}$ versus time',fontsize=12)
        plt.xlabel(u'time(yr)',fontsize=12)
        plt.ylabel(u'$\Delta{\omega}$(radians/yr)',fontsize=12)
        plt.legend(fontsize=10,loc='best')
        plt.sca(ax4)
        plt.plot(self.t[3],self.dw[3],'r',label=r'd$\Theta$=0.01,v=3 Elliptical orbit')
        plt.title(r'Hyperion  $\Delta{\omega}$ versus time',fontsize=12)
        plt.xlabel(u'time(yr)',fontsize=12)
        plt.ylabel(u'$\Delta{\omega}$(radians/yr)',fontsize=12)
        plt.legend(fontsize=10,loc='best')
